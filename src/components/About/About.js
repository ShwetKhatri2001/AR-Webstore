        ...
        <>
            ...
            <div className="learning-about">
                ...
                <ul className="about-res-ul">
                    ...
                    <li>
                        <div>
                            <a><iframe className='yt-res' src="https://www.youtube.com/embed/gAzIkjkJSzM?si=66Slz3nUzBZC-b5i" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></a>
                        </div>
                    </li>
                </ul >
            </div >
